...
public:
	...
	void rotateLocally(float delta_t);
	...
	void shadingPass(const ShadowMap* sm, glm::mat4& vp, glm::vec3 c, float f);
	void setUniformsForShadingPass(glm::mat4& vp, glm::vec3 c, int id, float f);
	virtual void draw();
