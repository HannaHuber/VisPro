...
BlinnPhongShader::BlinnPhongShader(vec3 amb_col, vec3 diff_col, glm::vec3 spec_col, float shin, float transp)
...
, transparency(transp)
{
	...
	auto transp_location = glGetUniformLocation(programHandle, "material.transparency");
	...
	glUniform1f(transp_location, transparency);
